...
ORIGINAL_IMAGE_1=imread('origpic0000.jpg');
ORIGINAL_IMAGE_2=imread('origpic0040.jpg');


[height,width]=size(ORIGINAL_IMAGE_1);
ORIGINAL_IMAGE_1=im2double(rgb2gray(ORIGINAL_IMAGE_1));
ORIGINAL_IMAGE_2=im2double(rgb2gray(ORIGINAL_IMAGE_2));
